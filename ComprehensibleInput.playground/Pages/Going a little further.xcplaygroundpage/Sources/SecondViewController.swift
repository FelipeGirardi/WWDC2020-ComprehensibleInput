...
public class SecondViewController: UIViewController {
    ...
    let comerButton = UIButton()
    let frutasButton = UIButton()
    let yButton = UIButton()
    let verdurasButton = UIButton()
    let esButton = UIButton()
    ...
    let buttonTextsES = ["Comer", "frutas", "y", "verduras", "es", "saludable."]
    let labelTextsEN = ["Eating", "fruits", "and", "vegetables", "is", "healthy."]
    let audioFileNames = ["Comer", "Frutas", "Y", "Verduras", "Es", "Saludable"]
    let emojiList = ["🍽", "🍎🍐🍌", "", "🥕🍅🥦", "", "👨‍⚕️👍"]
    let colorsList = [#colorLiteral(red: 0.5019607843137255, green: 0.5019607843137255, blue: 0.5019607843137255, alpha: 1.0), #colorLiteral(red: 0.9098039215686274, green: 0.47843137254901963, blue: 0.6431372549019608, alpha: 1.0), #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), #colorLiteral(red: 0.7215686274509804, green: 0.8862745098039215, blue: 0.592156862745098, alpha: 1.0), #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), #colorLiteral(red: 0.9764705882352941, green: 0.8509803921568627, blue: 0.5490196078431373, alpha: 1.0)]
    let fontsList = [UIFont.systemFont(ofSize: 40.0, weight: .bold), UIFont.systemFont(ofSize: 40.0, weight: .bold), UIFont.systemFont(ofSize: 40.0, weight: .regular), UIFont.systemFont(ofSize: 40.0, weight: .bold), UIFont.systemFont(ofSize: 40.0, weight: .regular), UIFont.systemFont(ofSize: 40.0, weight: .bold)]
    ...
    func prepareLayout() {
        ...
        buttonsES = [comerButton, frutasButton, yButton, verdurasButton, esButton, saludableButton]
        labelsEN = [eatingLabel, fruitsLabel, andLabel, vegetablesLabel, isLabel, healthyLabel]
...
extension SecondViewController: AVAudioPlayerDelegate {
    ...
    public func audioPlayerDidFinishPlaying(_ player: AVAudioPlayer, successfully flag: Bool) {
        if(!self.didPressWordToWordButton) {
            if(flag && (self.indexFlag == 0 || self.indexFlag == 1 || self.indexFlag == 3 || self.indexFlag == 5) && !self.didPressWordToWordButton) {
    ...
    func wordByWordAnimations(counter: Int) {
        ...
        // Animate label image
        if(counter == 0 || counter == 1 || counter == 3 || counter == 5) {
            UIView.animate(withDuration: 0.25, animations: {
